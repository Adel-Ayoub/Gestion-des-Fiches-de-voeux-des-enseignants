                    ...
                    <tbody>
                        {choices.map((choix, index) => (
                            <tr key={index} className="">
                                <td>{choix}</td>
                                <td>
                                    <select className="bg-gray-200 m-3 p-1 rounded" onChange={(e) => {setLevel(e.target.value);setSelectedCourses(filterbyLevel());console.log(selectedCourses)}}>
                                ...
                                <td>
                                    <select className="bg-gray-200 m-3 p-1 rounded" onChange={(e) => {setSpecialty(e.target.value);setSelectedCourses(filterbySpecialty());console.log(selectedCourses)}}>
                                ...
                                <td>
                                    <select className="bg-gray-200 m-3 p-1 rounded" onChange={(e) => setCourseName(e.target.value)}>
                                        {selectedCourses.map((c) => (
                                            <option key={c.id} value={c.moduleName}>{c.moduleName}</option>
                                        ))}
                                    </select>
                                </td>
...
<div className="section">
  <label>Choix d'enseignements du Semestre2</label>
  <table className="choise-table">
    <thead>
      <tr>
        <th className="text-center">Choix</th>
    ...
    <tbody>
      {choices.map((choix, index) => (
        <tr key={index}>
          <td>{choix}</td>
          <td>
            <select className="bg-gray-200 m-3 p-1 rounded" onChange={(e) => { setLevel(e.target.value); setSelectedCourses(filterbyLevel()); }}>
          ...
          <td>
            <select className="bg-gray-200 m-3 p-1 rounded" onChange={(e) => { setSpecialty(e.target.value); setSelectedCourses(filterbySpecialty()); }}>
